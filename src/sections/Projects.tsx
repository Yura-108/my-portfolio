  ...
  return (
    <section className={`w-full container mx-auto ${className} mt-15 md:mt-25 lg:mt-37.5`}>
      ...
      <div className="relative w-80 h-75.5 grid grid-rows-2 grid-cols-2">
        ...
        <div className="">
          <img width="155" height="146" src="/img1.jpg" alt=""/>
        </div>
        ...
        <div className="flex justify-end items-end">
          <img width="155" height="146" src="/img2.jpg" alt=""/>
        </div>
      </div>
...
export function ProjectsDesktop({className}: {className?: string}) {
  return (
    <section className={`w-full container mt-25 ${className}`}>
      ...
      <div className="grid w-full h-164.25 lg:h-277 xl:h-396 grid-rows-3 grid-cols-3">
      <Reveal>
        <div className="relative w-full h-full ">
          ...
          <div className="absolute h-107.25 w-0.5 bg-black right-0 top-0
          lg:h-182 xl:h-261
          "
          />
          <div className="absolute w-116 h-0.5 bg-black bottom-0 left-0
          lg:w-196 xl:w-277
          "/>
        </div>
      </Reveal>
      ...
      <div className="relative w-full h-full flex justify-center items-center">
        ...
        <div className="absolute
          h-107.25 w-0.5 bg-black right-0 top-2.25 lg:top-2.5 xl:top-3
          lg:h-182 xl:h-261
        "/>
        <div className="absolute
          w-116 h-0.5 bg-black bottom-0 left-2.25 lg:left-2.25 xl:left-3
          lg:w-196 xl:w-277
          "
      ...
      <div className="w-full h-full flex justify-end items-end">
       <div className="w-56.5 h-52.25 lg:w-96.75 lg:h-89.25 xl:w-136 xl:h-129 bg-[#cab9e6] flex justify-center items-center">
